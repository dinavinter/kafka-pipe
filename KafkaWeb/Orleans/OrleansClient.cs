    ...
    public class ClusterService : IHostedService
    {
        ...
        public ClusterService(ILogger<ClusterService> logger)
        {
            ...
            Client = new ClientBuilder()
                .ConfigureApplicationParts(manager => manager.AddApplicationPart(typeof(IConsumerGrain).Assembly).WithReferences())
                // .ConfigureApplicationParts(manager => manager.AddApplicationPart(typeof( ConsumerGrain).Assembly).WithReferences())
